...
""" Multi-line Docstring Comment
    Note: the autoDocstring VSCode extension can be used to automatically generate docstrings
"""
...
# None (or null) Data Type | The only way to define variables without assigning a proper value in Python
memory_card = None
...
# Enum (extra data type included in the enum module from the Python Standard Library)
class Day (Enum): 
    MONDAY = 1 
    TUESDAY = 2
    WEDNESDAY = 3 
...
# Constants can't be declared in Python. Instead, Uppercase variable names are used to define variable that shouldn't change
MAX_PLAYER = 100
